...
function start() {
	...
	// check the boar for a win or lose
	function checkBoard() {
		// make const thet shows all sinning Arrays
		const winningArrays = [
			[0, 1, 2, 3],
			[41, 40, 39, 38],
			[7, 8, 9, 10],
		...
		for (let y = 0; y < winningArrays.length; y++) {
			...
			// now check those arreyas to see if they all have the class of player-one
			if (
			...
			// check for player two
				...
				// if they do, player-two is passes as the winner
